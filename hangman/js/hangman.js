...
var Hangman = (function ($, window) {
  ...
  function doInit() {
    console.log("%c KSB %c Hangman v1.0.10", "background-color: #1358A3; color: white; font-weight: bold; font-style: italic; font-size: 150%;", "background-color: white; color: #1358A3; font-weight: bold; font-size: 150%;");
    console.log("2017 FG Inf <joern.steffen@ksb-sg.ch>, Kantonsschule am Brühl, St. Gallen. ", "color: #1358A3; font-weight: bold;");
